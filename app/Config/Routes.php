...
// Result Routing
$routes->match(['get','post'],'e-result', 					'Result::checkResult');
$routes->match(['get','post'],'admin/e-card', 					'Result::cardGenerator');


//Admin  
$routes->match(['get','post'],'admin', 					'Admin::index');
$routes->match(['get','post'],'admin/dashboard', 		'Admin::index');
$routes->match(['get','post'],'admin/subjects', 		'Admin::add_course');
