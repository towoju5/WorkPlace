...
<script type='text/javascript'>
    swal("Viola!", "<?= $session->getFlashdata('success') ?>!", "success");
</script>
...
<!-- page js -->
<script type="text/javascript" src="<?= base_url() ?>/assets/vendors/datatables/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="<?= base_url() ?>/assets/vendors/datatables/dataTables.bootstrap.min.js"></script>
<script type="text/javascript" src="<?= base_url() ?>/assets/js/pages/datatables.js"></script>
